...
import 'package:instituto/features/batch/widgets/batch_student.dart';
                    ...
                    GestureDetector(
                        onTap: () {
                          Navigator.pushReplacementNamed(
                              context, BatchScreen.routeName + widget.id);
                        },
                        child: const Icon(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              batchController.batchDetails.value!.teacherName,
                              style: const TextStyle(
                                  fontSize: 11, fontWeight: FontWeight.bold),
                            )
                          ],
                        ...
                        Row(
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {},
                              child: const Text(
                                '2:30PM - 4:00PM', //batchController.batchDetails.value!.timing
                                style: TextStyle(
                                    color: Colors.blue,
                                    fontSize: 11,
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            CustomDropdown(
                              ...
                              dropDownValue:
                                  authController.classDropdownValue.value,
                              onDropdownSelection:
                                  authController.onClassDropdownValueChange,
                            )
                          ],
                        ),
                        const SizedBox(
                              ...
                              switch (snapshot.connectionState) {
                                ...
                                case ConnectionState.done:
                                  return (alertsController
                                          .requestToJoin.value.isNotEmpty
                                      ? Padding(
                                          padding:
